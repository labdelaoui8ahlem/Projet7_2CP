...
/* PerformanceTacticParserTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. PerformanceTacticParserTokenManager.java */
...
public class PerformanceTacticParserTokenManager implements PerformanceTacticParserConstants {
    ...
    /** Constructor. */
    public PerformanceTacticParserTokenManager(SimpleCharStream stream){
    ...
    /** Constructor. */
    public PerformanceTacticParserTokenManager (SimpleCharStream stream, int lexState){
        ReInit(stream);
        SwitchTo(lexState);
    }
